import prod1Img from "./../../assets/img/feature_prod_01.jpg";
import prod2Img from "./../../assets/img/feature_prod_02.jpg";
import prod3Img from "./../../assets/img/feature_prod_03.jpg";
      ...
      <div className="container py-5">
        ...
        <div className="row">
          <div className="col-12 col-md-4 mb-4">
            <div className="card h-100">
              <a href="shop-single.html">
                <img src={prod1Img} className="card-img-top" alt="..." />
              </a>
          ...
          <div className="col-12 col-md-4 mb-4">
            <div className="card h-100">
              <a href="shop-single.html">
                <img src={prod2Img} className="card-img-top" alt="..." />
              </a>
              <div className="card-body">
                <ul className="list-unstyled d-flex justify-content-between">
          ...
          <div className="col-12 col-md-4 mb-4">
            <div className="card h-100">
              <a href="shop-single.html">
                <img src={prod3Img} className="card-img-top" alt="..." />
              </a>
              <div className="card-body">
                <ul className="list-unstyled d-flex justify-content-between">
